package com.sli.common.security.constant;
...
public interface SecurityConstants {
    ...
    String DEFAULT_SIGN_IN_PROCESSING_URL_SSOLOGIN = "/auth/ssoLogin";
    /**
     ...
     * 默认的用户名密码登录请求处理url
     */
    String DEFAULT_UAA_SIGN_IN_PROCESSING_URL_FORM = "/uaa/auth/login";
}